                ...
                availableBooks.map((book) => (
                  <label
                    ...
                    className={`flex items-center p-3 hover:bg-gray-50 cursor-pointer border-b border-gray-100 last:border-b-0 ${
                      selectedBookId === book._id ? "bg-orange-50" : ""
                    }`}
                  >
                    <input
                      type="radio"
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500">
                        Available: {book.availableCopies}/{book.totalCopies} | ISBN: {book.isbn}
                      </p>
                    </div>
                  </label>
                ))
              ...
              {activeMembers.length > 0 ? (
                activeMembers.map((member) => (
                  <label
                    key={member._id}
                    className={`flex items-center p-3 hover:bg-gray-50 cursor-pointer border-b border-gray-100 last:border-b-0 ${
                      selectedMemberId === member._id ? "bg-orange-50" : ""
                    }`}
                  >
                    <input
                      type="radio"
          ...
          {selectedBook && selectedMember && (
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="text-sm text-gray-600 space-y-1">
                <p>
                  <span className="font-medium">Book:</span> {selectedBook.title}
                </p>
                <p>
